...
class DenseDepthHead(DepthBaseDecodeHead):
    ...
    Args:
        ...
        fpn (bool): Whether apply FPN head. FPN: Feature Pyramid Networks
            Default: False
    ...
    def __init__(self,
        ...
        self.up_sample_channels = up_sample_channels[::-1]  # 倒序翻转
    ...
    def forward(self, inputs):
        ...
        if self.fpn:
            ...
            for index, feat in enumerate(inputs[::-1]):
                ...
                if index != 0:
                    y = cur_fpn + F.interpolate(temp_feat_list[-1], size=cur_fpn.shape[-2:], mode="bilinear",
                                                align_corners=True)
                else:
                    y = cur_fpn
