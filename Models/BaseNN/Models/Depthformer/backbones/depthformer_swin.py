...
# from models.ops.wrappers import resize
from Models.BaseNN.Models.Depthformer.utils.logger import get_root_logger
from Models.BaseNN.Models.Depthformer.builder import BACKBONES

from Models.BaseNN.Models.Depthformer.utils.ckpt_convert import swin_convert
from Models.BaseNN.Models.Depthformer.utils.embed import PatchEmbedSwin as PatchEmbed

from Models.BaseNN.Models.Depthformer.ops.wrappers import resize
from .resnet import BasicBlock, Bottleneck
from Models.BaseNN.Models.Depthformer.utils import ResLayer
...
class DepthFormerSwin(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 conv_cfg=None,
                 conv_norm_cfg=dict(type='BN', requires_grad=True),  # 更改了这里默认的
                 depth=18,
                 num_stages=0,
                 with_cp=False,
